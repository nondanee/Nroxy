...
Java_dev_nondanee_nroxy_TunnelService_jni_1init(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_dev_nondanee_nroxy_TunnelService_jni_1start(
...
JNIEXPORT void JNICALL
Java_dev_nondanee_nroxy_TunnelService_jni_1stop(
...
Java_dev_nondanee_nroxy_TunnelService_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}


JNIEXPORT void JNICALL
Java_dev_nondanee_nroxy_TunnelService_jni_1done(JNIEnv *env, jobject instance) {
